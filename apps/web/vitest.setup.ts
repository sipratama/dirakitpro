...
// build (as Vitest does) throws "is not a function". Stub both as font-loader-
// shaped functions; no test asserts on actual font output. Named (not dynamic/
// Proxy) because Vitest's ESM mock handling requires statically known export
// names — add a new entry here if another route loads a font.
